...
namespace Shoko.Server.API.v3.Controllers
{
    ...
    public class GroupController : BaseController
    {
        ...
        /// <returns></returns>
        [HttpGet]
        public ActionResult<ListResult<Group>> GetAllGroups([FromQuery] [Range(0, 100)] int pageSize = 50, [FromQuery] [Range(1, int.MaxValue)] int page = 1, [FromQuery] bool includeMissing = false, [FromQuery] bool randomImages = false, [FromQuery] bool topLevelOnly = true, [FromQuery] string startsWith = "")
        {
